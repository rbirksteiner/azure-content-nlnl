...
2. **Restart** your Linux VM from the portal. From the [Azure portal](https://portal.azure.com), click **Browse all** > **Virtual machines** > your Windows virtual machine > **Restart**.
